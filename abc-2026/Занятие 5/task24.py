...
for message in messages:
    offset = offset - 1
    for char in message:
        if char in alphabet:                               #записывает зашифрованную рус. букву
            index = alphabet.index(char)                   #на место изначальной рус. буквы
            new_index = (index + offset) % len(alphabet)   #в файле message.txt
